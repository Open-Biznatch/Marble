...
In order to support loading of multiple wallets in marble-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is marble.cpp.
...
Changes to marble.cpp
----------------------
marble.cpp is the entry point into marble-qt, and as such, will require some minor modifications to provide hooks for
