                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Marble Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Marble address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and marble: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMARCO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Marble Core"), this);
    aboutAction->setStatusTip(tr("Show information about Marble Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Marble"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Marble addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Marble addresses"));
    ...
    openAction->setStatusTip(tr("Open a Marble: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Marble Core help message to get a list with possible Marble command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Marble Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Marble Core"); // default title
...
/** Creates context menu, its actions, and marbles up all the relevant signals for mouse events. */
