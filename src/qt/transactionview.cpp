                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Marble from zMarble"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMarble"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMarble));
