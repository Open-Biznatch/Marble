Contributing to Marble Core
============================

The Marble Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Marble Core project, and is not to be
confused with overall Marble Network Protocol consensus changes.

Whether a pull request is merged into Marble Core rests with the project merge
...
Patches that change Marble consensus rules are considerably more involved than
...
Where a patch set proposes to change the Marble consensus, it must have been
...
The project leader is the release manager for each Marble Core release.
