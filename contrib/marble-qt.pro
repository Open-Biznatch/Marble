...
RESOURCES += src/qt/marble.qrc src/qt/marble_locale.qrc

TRANSLATIONS += src/qt/locale/marble_bg.ts \
                src/qt/locale/marble_de.ts \
                src/qt/locale/marble_en.ts \
                src/qt/locale/marble_es.ts \
                src/qt/locale/marble_fi.ts \
                src/qt/locale/marble_fr.ts \
                src/qt/locale/marble_it.ts \
                src/qt/locale/marble_ja.ts \
                src/qt/locale/marble_pl.ts \
                src/qt/locale/marble_pt.ts \
                src/qt/locale/marble_ru.ts \
                src/qt/locale/marble_sk.ts \
                src/qt/locale/marble_sv.ts \
                src/qt/locale/marble_vi.ts \
                src/qt/locale/marble_zh_CN.ts \
                src/qt/locale/marble_zh_TW.ts
